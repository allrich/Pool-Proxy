...
安装好 wget 之后 下载脚本并执行
```bash
wget https://github.com/allrich/Miner-Proxy.git
```
...
# Liunx-手动安装
```bash
git clone https://github.com/allrich/Miner-Proxy.git
cd MinerProxy
...
# Windows-使用方法
```bash
./MinerProxy-windows.exe
```
或双击打开MinerProxy-windows.exe 运行成功后访问 IP:18888 (如：127.0.0.1:18888 注意开放端口) 进行配置即可。
